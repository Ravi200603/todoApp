  ...
  return (
    <div className='overflow-x-hidden h-screen'>
      <div className=' md:w-4/5 h-15 md:my-4 mx-2 m-2 rounded-md shadow-md md:mx-auto'>
        <input className='w-3/4 h-full text-center rounded-tl-md rounded-bl-md border-2 border-black outline-none' placeholder="Enter task here " type="text" value={inputText} onChange={(e)=> setInputText(e.target.value)} onKeyDown={(e)=>{ if(e.key === 'Enter'){
          addTodo(e)
        }}}/>
    ...
    <div className={`border-2 m-2 rounded-md shadow-md p-2 md:w-4/5 md:mx-auto overflow-auto max-h-[85vh] ${todos.length ===0 ?'hidden' : ''} `}>
